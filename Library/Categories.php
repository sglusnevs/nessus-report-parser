...
class Classifier {
    ...
    function get($vulnerability) {
        ...
        $rules = array(
          # Malware
          '/Malicious Process/' => array('Malware', "Verdacht auf Malware-Program", "Signatur von einem Windows Process sieht dem Malware ähnlich", "n/a", 'high'),
          # patches management
          ...
          '/(MS\s*\d+|MS KB\s*\d+|KB\s*\d+)|Windows Summary of Missing Patches|MS Security Advisory|Windows Service Pack Out-of-Date/' => array('MS-KB', "Patch-Management von Microsoft Windows", "Windows-System befindet sich nicht auf dem neusten Update-Level", "Es ist empfohlen, fehlende Updates zu installieren", 'high'),
          '/Microsoft Office Service Pack/' => array('MS-OFFICE', "Patch-Management von Microsoft Office", "Microsoft Office befindet sich nicht auf dem neusten Update-Level", "Es ist empfohlen, fehlende Updates zu installieren", 'high'),
          '/Microsoft .NET Framework Service Pack Out of Date/' => array('MS-DOTNET', "Patch-Management von Microsoft .NET Framework", "Microsoft .NET Framework befindet sich nicht auf dem neusten Update-Level", "Es ist empfohlen, fehlende Updates zu installieren", 'high'),
          ...
          '/^Adobe Reader/' => array('AdobeReader', "Patch-Management von Drittanwendungen", "Adobe Reader Schwachstellen", "Es wird empfohlen, Updates zu installieren", 'high'),
          ...
          '/^Macrovision SafeDisc/' => array('MacrovisionSD', "Patch-Management von Drittanwendungen", "Macrovision SafeDisc Schwachstellen", "Es wird empfohlen, Updates zu installieren", 'high'),
          ...
          # Antivirus
          '/Anti-Virus/' => array('Antivirus', "Probleme mit Antivirus Program", "System ist von dem Antivirus Program nicht mehr adequat geschützt", "Überprüfen Sie, ob Antivirus Program aktuell gepatcht und mit aktueller Virus-Datenbank versorgt ist", 'high'),
          # DoS/DDos
